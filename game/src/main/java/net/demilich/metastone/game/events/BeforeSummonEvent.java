...
public final class BeforeSummonEvent extends SummonEvent {
	...
	public BeforeSummonEvent(@NotNull GameContext context, @NotNull Actor minion, @NotNull Entity source, boolean didResolveBattlecry, OpenerAction openerAction) {
		super(context, minion, source, didResolveBattlecry, openerAction);
	}
