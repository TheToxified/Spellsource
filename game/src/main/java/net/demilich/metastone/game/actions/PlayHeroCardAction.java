...
/**
 * Indicates playing a hero card from the hand. This will eventually call {@link net.demilich.metastone.game.logic.GameLogic#changeHero(Player, net.demilich.metastone.game.entities.Entity, Hero, boolean)}. Since it is played from the hand, battlecries are resolved.
 */
public class PlayHeroCardAction extends PlayCardAction implements HasOpener {
	...
	public void innerExecute(GameContext context, int playerId) {
		...
		context.getLogic().changeHero(context.getPlayer(playerId), heroCard, hero, true);
	}
