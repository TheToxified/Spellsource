...
public final class EnchantmentDesc implements Serializable, Cloneable, HasEntrySet<EnchantmentDescArg, Object>, AbstractEnchantmentDesc<Enchantment> {
	 ...
	 * <p>
	 * The enchantment's {@link Trigger#setHostReference(net.demilich.metastone.game.targeting.EntityReference)} call should be applied immediately afterwards to specify the
