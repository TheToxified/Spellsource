 ...
 * <p>
 * Enchantments live inside {@link net.demilich.metastone.game.logic.GameLogic#getActiveTriggers(EntityReference)}; some
 * enchantments, like {@link Secret} and {@link Quest}, live in their respective zones {@link Zones#QUEST} and {@link
 * Zones#SECRET}.
 * <p>
...
public class Enchantment extends Entity implements Trigger {
	...
	private static final Zones[] DEFAULT_GAME_ZONES = new Zones[]{Zones.DISCOVER, Zones.SET_ASIDE_ZONE, Zones.DECK};
	...
	public void onGameEvent(GameEvent event) {
		...
		if (event.getEventType() != EventTypeEnum.BOARD_CHANGED
				...
				&& hostReference != null
				&& !(hostReference.equals(EntityReference.PLAYER_1)
				|| hostReference.equals(EntityReference.PLAYER_2))) {
